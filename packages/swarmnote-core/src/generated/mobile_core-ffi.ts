...
interface NativeModuleInterface {
    ...
    ubrn_uniffi_mobile_core_fn_func_greet(name: Uint8Array, uniffi_out_err: UniffiRustCallStatus): Uint8Array;
    ubrn_uniffi_mobile_core_checksum_func_greet(): number;
