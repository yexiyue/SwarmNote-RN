...
class NativeMobileCore : public jsi::HostObject {
  ...
  protected:
    ...
    jsi::Value cpp_uniffi_mobile_core_fn_func_greet(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count);
    jsi::Value cpp_uniffi_mobile_core_checksum_func_greet(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count);
