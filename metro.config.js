...
// @swarmnote/editor-{core,react-native} 通过 pnpm.overrides 链到 sibling 仓
// `../swarmnote-editor/packages/{editor-core,editor-react-native}`。
// v0.4 起 editor-web 已合并进 editor-react-native(./webview)，不再是独立包。
